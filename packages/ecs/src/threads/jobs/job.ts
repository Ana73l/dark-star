...
/**
 * Utility type representing possible {@link Job} arguments.
 *
 * @remarks
 * Used internally to map types of {@link Job job} arguments in callbacks.
 *
 * @see
 * {@link JobCallbackMappedArgs}
 */
export type JobArgs = [any] | any[];

/**
 * Utility type representing mapped {@link JobArgs} for a callback.
 *
 * @see
 * {@link JobArgs}
 */
