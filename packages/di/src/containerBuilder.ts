import { ClassType, InjectableIdentifier, Instance, Factory, InjectableData, Container } from './types';
...
export interface ContainerBuilder {
    ...
    registerTransient<T>(identifier: InjectableIdentifier<T>, constructor: ClassType<T> | Factory<T>): ContainerBuilder;

    registerSingleton<T>(constructor: ClassType<T>): ContainerBuilder;
    registerSingleton<T>(identifier: InjectableIdentifier<T>, constructor: ClassType<T> | Factory<T>): ContainerBuilder;
    registerSingleton<T>(identifier: InjectableIdentifier<T>, instance: Instance<T>): ContainerBuilder;
